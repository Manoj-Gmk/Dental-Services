    ...
    <>
      ...
      <div className="container">
        <div className="FAQ-container">
          <h3 id="first">1. What are your clinic hours?</h3>
          <p className="para">
        ...
        <div className="FAQ-container">
          <h3 id="first">2. How do I book an appointment?</h3>
          <p className="para">
        ...
        <div className="FAQ-container">
          <h3 id="first">3. How often should I visit the dentist?</h3>
          <p className="para">
            {" "}
        ...
        <div className="FAQ-container">
          <h3 id="first">4. Can I visit the dentist during pregnancy?</h3>
          <p className="para">
        ...
        <div className="FAQ-container">
          <h3 id="first">5. Do you accept dental insurance?</h3>
          <p className="para">
        ...
        <div className="FAQ-container">
          <h3 id="first">6. What services do you offer?</h3>
          <p className="para">
